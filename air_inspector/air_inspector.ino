...
void loop() {
  while(1){
    for (uint8_t i = 0; i < max_fig_number; i++){
      ...
      update_item_value(i, item_number_CO2,  0);
      update_item_value(i, item_number_TVOC, 0);
      update_item_value(i, item_number_CH2O, 0);
      update_item_value(i, item_number_PM25, 0);
      update_item_value(i, item_number_PM10, 0);
      update_item_value(i, item_number_TEMP, 0);
      update_item_value(i, item_number_RH,   0);
      ...
      while(!flag_to_update_fig){
        ...
        if (u_TW07ST.update_value() && u_TW07ST.CO2_value != 0){
          update_item_value(i, item_number_CO2,  u_TW07ST.CO2_value);
          update_item_value(i, item_number_TVOC, u_TW07ST.TVOC_value);
          update_item_value(i, item_number_CH2O, u_TW07ST.CH2O_value);
          update_item_value(i, item_number_PM25, u_TW07ST.PM25_value);
          update_item_value(i, item_number_PM10, u_TW07ST.PM10_value);
          update_item_value(i, item_number_TEMP, u_TW07ST.TEMP_value*10);
