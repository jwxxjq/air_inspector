...
void SERSOR_SERIAL::print_value(uint16_t PM2_5_value, uint16_t PM10_value, uint16_t CO2_value, uint16_t HCHO_value, uint16_t Temperature_value, uint16_t Humidity_value){
  ...
  //Serial.begin(9600);
  uint8_t Temperature_value_high_byte = Temperature_value/100;
  uint8_t Temperature_value_low_byte = Temperature_value%100;
  uint8_t Humidity_value_high_byte = Humidity_value/100;
  uint8_t Humidity_value_low_byte = Humidity_value%100;
